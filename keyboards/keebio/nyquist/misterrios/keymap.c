...
#define DE_BSLS RALT(KC_NUBS) // Backslash
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      | Super| Lower| Ctrl/Enter  | Space       |Raise | GUI  |      |      |
 * `-----------------------------------------------------------------------------------'
...
[_COLEMAK] = LAYOUT( \
  ...
  _______, _______, KC_LGUI, LOWER, CTL_T(KC_ENT), CTL_T(KC_ENT), KC_SPC, KC_SPC, RAISE, GUI, _______, _______ \
 ),
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, CTL_T(KC_LCTL), _______, _______, KC_UP,   _______, _______, KC_P1,   KC_P2,   KC_P3, \
  _______, _______, KC_LALT, _______, KC_DEL,  KC_DEL,  KC_BSPC, KC_BSPC, _______, KC_P0,   KC_PDOT, KC_PENT \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_NLCK, DE_AUML, _______, DE_ESZT, DE_LPAR, DE_RPAR,  _______, DE_PIPE, DE_BSLS, DE_TLDE, DE_OUML, _______, \
  KC_LCAP, _______, _______, _______, DE_LBRC, DE_RBRC,_______, _______, _______, _______, _______, _______, \
 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Play |PrvTrk|NxtTrk|      |      |      |      |      | PgUp | M Up | Home |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Mplay| Vol- | Vol+        |      |      |      |      |PgDown|M Down| End  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |  Sleep      |  Lock       |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_GUI] =  LAYOUT( \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______, KC_PGUP, KC_WH_U, KC_HOME, _______, \
  KC_MSEL, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, KC_PGDN, KC_WH_D, KC_END,  _______, \
  _______, _______, _______, _______, KC_SLEP, KC_SLEP, LGUI(KC_L), LGUI(KC_L), _______, _______, _______, _______  \
)

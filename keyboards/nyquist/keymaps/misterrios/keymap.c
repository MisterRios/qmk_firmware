 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Play |PrvTrk|NxtTrk|      |      |      |      |      |      | M Up |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | Mplay| Vol- | Vol+        |      |      |      |      |      |M Down|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |  Sleep      |  Lock       |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_GUI] =  LAYOUT( \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______, _______, KC_WH_U, _______, _______, \
  KC_MSEL, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, KC_WH_D, _______, _______, \

...
[_COLEMAK] = LAYOUT( \
  ...
  KC_ESC,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_RBRC, \
 ...
 * |      |      |      |      |      |      | Up   | Iso ~|      |  1   |   2  |  3   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |      | Alt  |      |  Backspace  | Delete      |      |  0   |  .   |Return|
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
  KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, \
  _______, _______, _______, _______, _______, _______, KC_DOWN, KC_RGHT, _______, KC_P7,   KC_P8,   KC_P9, \
  _______, _______, _______, _______, _______, _______, KC_LEFT, KC_AT, ALTG(KC_E), KC_P4,  KC_P5,   KC_P6, \
  _______, _______, _______, _______, _______, _______, KC_UP,   KC_TILD, _______, KC_P1,   KC_P2,   KC_P3, \
  KC_LCTL, _______, KC_LALT, _______, KC_BSPC, KC_BSPC, KC_DEL,  KC_DEL,  _______, KC_P0,   KC_PDOT, KC_PENT \
),
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, ALTG(KC_8), ALTG(KC_9),  _______, _______, KC_LBRC,  _______, _______, _______, \
  _______, KC_QUOT, _______, KC_MINS, ALTG(KC_5), ALTG(KC_6),  _______, _______, _______, _______, KC_SCLN, _______, \

...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, KC_LCTL, _______, _______, KC_UP,   _______, _______, KC_P1,   KC_P2,   KC_P3, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_CAPS, _______, _______, _______, DE_LBRC, DE_RBRC,_______, _______, _______, _______, _______, _______, \
